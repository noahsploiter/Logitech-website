  ...
  return (
    <div>
      <div className="relative overflow-hidden rounded-lg shadow-lg cursor-pointer">
        ...
        <div className="absolute top-0 mt-[100px] space-y-6 left-0 px-6 py-4 w-full flex justify-center flex-col items-center">
          <h4 className="mb-3 text-4xl  font-semibold tracking-tight text-white ">
            Logitech Graphic Tablet-Space Gamer rE0
          </h4>
          <p className="leading-normal text-gray-100 text-2xl font-mono">
